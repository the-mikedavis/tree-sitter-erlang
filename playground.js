...
(async () => {
  ...
  async function handleLanguageChange() {
    ...
    if (!languagesByName[newLanguageName]) {
      const url = './tree-sitter-erlang.wasm'
  ...
  function loadState() {
    const language = localStorage.getItem("languageErlang");
    const sourceCode = localStorage.getItem("sourceCodeErlang");
    const query = localStorage.getItem("queryErlang");
    const queryEnabled = localStorage.getItem("queryEnabledErlang");
  ...
  function saveState() {
    localStorage.setItem("languageErlang", languageSelect.value);
    localStorage.setItem("sourceCodeErlang", codeEditor.getValue());
    saveQueryState();
  }

  function saveQueryState() {
    localStorage.setItem("queryEnabledErlang", queryCheckbox.checked);
    localStorage.setItem("queryErlang", queryEditor.getValue());
  }
