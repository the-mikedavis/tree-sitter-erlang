...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__anonymous_stab_clause, 5, .production_id = 23),
  [469] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [471] = {.entry = {.count = 1, .reusable = true}}, SHIFT(117),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__named_stab_clause, 6, .production_id = 24),
  ...
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__named_stab_clause, 4, .production_id = 21),
  [485] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__anonymous_stab_clause, 3, .production_id = 16),
