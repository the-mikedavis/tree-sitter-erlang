...
enum {
  anon_sym_helloworld = 1,
  sym_source = 2,
};

static const char * const ts_symbol_names[] = {
  [ts_builtin_sym_end] = "end",
  [anon_sym_helloworld] = "hello world",
  [sym_source] = "source",
};

static const TSSymbol ts_symbol_map[] = {
  [ts_builtin_sym_end] = ts_builtin_sym_end,
  [anon_sym_helloworld] = anon_sym_helloworld,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 11:
      ...
      END_STATE();
    case 12:
      ACCEPT_TOKEN(anon_sym_helloworld);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [anon_sym_helloworld] = ACTIONS(1),
  },
  [1] = {
    [sym_source] = STATE(3),
    [anon_sym_helloworld] = ACTIONS(3),
  },
};
